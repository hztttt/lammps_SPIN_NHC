...
AtomVecSpin::AtomVecSpin(LAMMPS *lmp) : AtomVec(lmp)
{
  ...
  fields_grow = {"sp", "fm", "fm_long", "s_real", "v_s", "s_mass", "is_spin"};
  fields_copy = {"sp", "s_real", "v_s", "s_mass", "is_spin"};
  fields_comm = {"sp"};
  fields_comm_vel = {"sp", "v_s"};
  fields_reverse = {"fm", "fm_long"};
  fields_border = {"sp", "v_s", "s_real", "s_mass"};
  fields_border_vel = {"sp", "v_s", "s_real", "s_mass"};
  fields_exchange = {"sp", "s_real", "v_s", "s_mass", "is_spin"};
  fields_restart = {"sp"};
  fields_create = {"sp", "v_s", "s_real", "s_mass"};
